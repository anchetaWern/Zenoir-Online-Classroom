...
<table class="tbl_classes">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="/zenoir/index.php/ajax_loader/view/view_classes" data-id="<?php echo $v[2]; ?>" class="lightbox"><img class="icons" src="/zenoir/img/view.png"/></a></td><!--view classes associated-->
		</tr>
		<?php } ?>
	</tbody>
</table>