...
<ul class="tabs left">
	...
	<li><a href="#notifications">Notifications (<?php echo $invite_count + $expired_count; ?>)</a></li>
...
<table>
	...
	<tbody>
		...
		<tr>
			<td><a href="<?php echo $this->config->item('page_base'); ?>class_home/<?php echo $v[5]; ?>" data-classid="<?php echo $v[5]; ?>"><?php echo $v[0] .' - '.$v[1]; ?></a></td><!--enter class-->
			<td><?php echo $v[2]; ?></td>
			<td><?php echo $v[3]; ?></td>
	...
	<table class="tbl_classes">
		...
		<?php foreach($people as $row){ ?>
			<tr>
				...
				<td><?php echo $row['class_code'] .' - '. $row['class_description'];  ?></td>
				<td><a href="<?php echo $this->config->item('ajax_base'); ?>view_user/<?php echo $row['id']; ?>" class="lightbox" data-id="<?php echo $row['id']; ?>"><img src="/zenoir/img/view.png" class="icons"/></a></td>
			</tr>
		<?php } ?>
		</tbody>
	</table>
