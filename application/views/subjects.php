...
<table class="tbl_classes">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="/zenoir/index.php/ajax_loader/view/view_classes" class="lightbox" data-id="<?php echo $v[2]; ?>"><img class="icons" src="/zenoir/img/view.png"/></a></td><!--view classes associated-->
		</tr>
		<?php } ?>
	</tbody>
</table>