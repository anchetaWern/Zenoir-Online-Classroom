...
switch($type_id){
	case 0: //document -only reads txt, pdf, xls, html 
			...
			echo "<a href='/zenoir/uploads/$filename'>$filename</a>";	
	break;
	...
	case 1: //video - only reads webm, mp4, and ogv
		...
		echo 	"<a href='/zenoir/uploads/$filename'>".$filename."</a><br/>";
		echo	"<video controls='controls' width='300' height='220'>
					<source src='/zenoir/uploads/$filename' type='video/$file_ext'; codecs='$codecs[$codec_id]'/>
				</video>";
	break;
	...
	case 2: //audio - mp3 only
		...
		echo 	"<audio controls='controls'>
					<source src='/zenoir/uploads/$filename' type='audio/mpeg'/>
					
				</audio>";
	break;
	
	case 3: //images - set content disposition on a php file to download directly
		echo 	"<a href='/zenoir/uploads/$filename'>".$filename."<br/>";
		echo 	"<img src='/zenoir/uploads/$filename'/>";
	break;
